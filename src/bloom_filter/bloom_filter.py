...
from bloom_filter.tools import false_positive_rate, minimal_memory_footprint
...
class BloomFilter:
    ...
    def minimal_false_positive_rate_bloom_filter(cls, bit_array_size, input_cardinal):
        ...
        floor_false_positive_rate = false_positive_rate(
            bit_array_size=bit_array_size,
            nb_salt=floor_nb_salt,
            input_cardinal=input_cardinal
        )
        ceil_false_positive_rate = false_positive_rate(
            bit_array_size=bit_array_size,
    ...
    def minimal_memory_bloom_filter(cls, input_cardinal, error_rate):
        minimal_bit_array_size = minimal_memory_footprint(
            input_cardinal=input_cardinal,
